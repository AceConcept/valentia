...
const ROOT =
  "flex h-[6.75rem] shrink-0 items-center justify-between gap-[0.75rem] border-b-[0.0625rem] border-v-border bg-[color:var(--v-chart-bg)] px-[1.3125rem] py-[1rem] font-light";
