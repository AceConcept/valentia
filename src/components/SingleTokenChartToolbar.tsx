const TOOLBAR_BTN =
  "inline-flex h-[2rem] shrink-0 items-center justify-center rounded-[0.375rem] border-[0.0625rem] border-v-border bg-transparent px-[1rem] font-mono text-[1.25rem] font-light uppercase leading-none tracking-[0.08em] text-v-subtle transition-[border-color,color,background-color] duration-150 hover:border-v-muted hover:text-foreground";

export function SingleTokenChartToolbar() {
  return (
    <div className="mb-[2.25rem] flex h-[4.75rem] w-full min-w-0 shrink-0 items-center gap-x-[2rem] overflow-x-auto rounded-[0.375rem] border-[0.0625rem] border-v-border bg-[#0a0a0a] px-[1.3125rem]">
